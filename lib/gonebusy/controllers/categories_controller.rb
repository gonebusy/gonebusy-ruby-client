...
module Gonebusy
  class CategoriesController
    ...
    # @param [Numeric] user_id Optional parameter: Retrieve Categories of all services provided by this User Id.  You must be authorized to manage this User Id.
    # @return GetCategoriesResponse response from the API call
    def get_categories api_key, page: 1, per_page: 10, user_id: nil
    ...
    def create_category create_category_body
      # the base uri for api requests
      query_builder = Configuration.BASE_URI.dup

      # prepare query string for API call
      query_builder << "/categories/new"
      ...
      # invoke the API call request to fetch the response
      response = Unirest.post query_url, headers:headers, parameters:create_category_body.to_json
    ...
    def get_category_by_id api_key, id
      # the base uri for api requests
      query_builder = Configuration.BASE_URI.dup

      # prepare query string for API call
      query_builder << "/categories/{id}"
