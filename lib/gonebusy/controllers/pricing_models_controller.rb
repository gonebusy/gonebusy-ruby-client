...
module Gonebusy
  class PricingModelsController
    ...
    # @param [Numeric] user_id Optional parameter: Retrieve PricingModels owned only by this User Id.  You must be authorized to manage this User Id.
    # @return GetPricingModelsResponse response from the API call
    def get_pricing_models api_key, page: 1, per_page: 10, user_id: nil
      # the base uri for api requests
      query_builder = Configuration.BASE_URI.dup

      # prepare query string for API call
      query_builder << "/pricing_models"
    ...
    def create_pricing_model create_pricing_model_body
      # the base uri for api requests
      query_builder = Configuration.BASE_URI.dup

      # prepare query string for API call
      query_builder << "/pricing_models/new"
      ...
      # invoke the API call request to fetch the response
      response = Unirest.post query_url, headers:headers, parameters:create_pricing_model_body.to_json
    ...
    def get_pricing_model_by_id api_key, id
      # the base uri for api requests
      query_builder = Configuration.BASE_URI.dup

      # prepare query string for API call
      query_builder << "/pricing_models/{id}"
    ...
    def update_pricing_model_by_id id, update_pricing_model_by_id_body
      # the base uri for api requests
      query_builder = Configuration.BASE_URI.dup
      ...
      # invoke the API call request to fetch the response
      response = Unirest.put query_url, headers:headers, parameters:update_pricing_model_by_id_body.to_json
